import svgPaths from "./svg-efrun0cyl6";
...
function LogIn() {
  return (
    <div className="bg-white content-stretch flex h-[960px] items-center min-h-[960px] relative shrink-0 w-full z-[1]" data-name="Log in">
      <Section />
      <Section1 />
    </div>
  );
